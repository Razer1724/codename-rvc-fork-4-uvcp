...
def create_uvcp(pth_path, index_path=None, output_path=None):
    """Create a Zstandard-compressed .uvcp file for the best balance of speed and size."""
    try:
        ...
        # Open a Zstandard file stream and save the data.
        # This provides excellent compression with very fast decompression speeds.
        # torch.load can handle this file object transparently.
